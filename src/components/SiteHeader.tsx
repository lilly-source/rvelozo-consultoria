    ...
    <header className="absolute top-0 left-0 right-0 z-30">
      <div className="mx-auto max-w-7xl px-6 lg:px-10 py-6 flex items-center justify-between">
        ...
        <nav className="hidden md:flex items-center gap-10 text-sm text-[var(--ink-soft)]">
          <a href="#metodo" className="hover:text-[var(--deep)] transition">Método</a>
          <a href="#autoridade" className="hover:text-[var(--deep)] transition">Autoridade</a>
          <a href="#servicos" className="hover:text-[var(--deep)] transition">Serviços</a>
